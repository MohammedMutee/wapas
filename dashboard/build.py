...
<style>
  ...
  /* Padding insets content instead of adding to width. Without this,
     `.viz-root` at width:100% with 48px of horizontal padding measured
     1920 + 48 + 48 = 2016px inside a 1920px window and the page scrolled
     sideways — the layout was not too narrow, it was too wide. */
  *, *::before, *::after {{ box-sizing:border-box; }}
  ...
  .viz-root {{
    ...
    max-width:none; margin:0; padding:40px clamp(20px, 3vw, 48px) 72px;
  }}
